...
(function () {
    ...
    function S() {
        for (var a = y.length, b = 0, c, g; b < a; b++)
            (c = y[b]),
                ...
                c.resize((g + 1) | 0, 35, !0).move((c.left + b * g) | 0, M - c.bottom - 35, !0);
    }
    function T(a, b) {
        function c(d) {
            t(d);
        ...
        function g(d) {
            ...
            if (p || v)
                p && (a.width = Math.max(Math.min(a.width, L - a.x - a.right), 150)),
                    v && (a.height = Math.max(Math.min(a.height, M - a.y - a.bottom), 35)),
                    a.resize();
            if (n || E)
    ...
    e.maximize = function (a) {
        if ("undefined" === typeof a || a !== this.max)
            this.min && U(this),
                (this.max = !this.max)
                    ? this.addClass("max")
                          .resize(L - this.left - this.right, M - this.top - this.bottom, !0)
    ...
    e.fullscreen = function (a) {
        if ("undefined" === typeof a || a !== C)
            this.min && (this.resize().move(), U(this)), (C && V()) || (this.body[G](), (C = !0));
        return this;
    };
    function V() {
        C = !1;
